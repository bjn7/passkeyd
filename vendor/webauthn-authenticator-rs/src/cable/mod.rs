...
pub use self::{base10::DecodeError, btle::Advertiser, tunnel::get_domain, tunnel::Tunnel};
...
pub async fn connect_cable_tunnel<'a, U: UiCallback + 'a>(
    request_type: CableRequestType,
    ui_callback: &'a U,
    ...
    let connect_uri = eid.get_connect_uri(tunnel_id).ok_or_else(|| {
